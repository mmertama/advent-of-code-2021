...
if __name__ == "__main__":
    ...
    # day21.dirac_dice_practice(day21.example)
    day21.dirac_dice_practice(day21.data)

    # day21.dirac_dice(day21.example)
    day21.dirac_dice(day21.data)
    ...
    # day23.organize_amphipods(read_example(day23.example))
    day23.organize_amphipods(read_example(day23.input_data))

    # day23.organize_amphipods_unfolded(read_example(day23.example2))
    day23.organize_amphipods_unfolded(read_example(day23.input_data2))

    day24.monad_max(read_input('data/input24.txt'))
    day24.monad_min(read_input('data/input24.txt'))

    # day25.sea_cucumber_stop(read_example(day25.example))
    day25.sea_cucumber_stop(read_input('data/input25.txt'))
